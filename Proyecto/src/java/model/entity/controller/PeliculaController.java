...
import model.entity.dao.PeliculaFacade;
...
public class PeliculaController implements Serializable {
    ...
    @EJB
    private model.entity.dao.PeliculaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("PeliculaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("PeliculaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("PeliculaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Pelicula getPelicula(java.lang.Long id) {
    ...
    public static class PeliculaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Pelicula) {
                ...
                return getStringKey(o.getIdpel());
            } else {
