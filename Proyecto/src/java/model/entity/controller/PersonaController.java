...
import model.entity.dao.PersonaFacade;
...
public class PersonaController implements Serializable {
    ...
    @EJB
    private model.entity.dao.PersonaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("PersonaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("PersonaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("PersonaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
